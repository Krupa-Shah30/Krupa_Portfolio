      ...
      <section className="mb-12 flex flex-col md:flex-row items-center justify-center text-center md:text-left gap-8">
        ...
        <div className="flex-1">
          ...
          <div className="flex gap-6 justify-center md:justify-start mb-6">
            {socials.map((item) => (
              <a key={item.label} href={item.href} target="_blank" rel="noopener" className="group relative flex items-center gap-2 text-lg font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-all duration-300 ease-in-out">
                {item.label === 'LinkedIn' && (
                ...
                {item.label === 'Tableau' && (
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M11.654 0v2.596h2.292V0h-2.292zm4.583 2.596h2.292v2.292h-2.292V2.596zM6.458 2.596h2.292v2.292H6.458V2.596zm5.196 2.292v2.292h2.292V4.888h-2.292zm-4.583 0v2.292h2.292V4.888H7.071zm9.167 0v2.292h2.292V4.888h-2.292zM2.292 4.888v2.292h2.292V4.888H2.292zm18.416 0v2.292H23V4.888h-2.292zM11.654 7.18v2.292h2.292V7.18h-2.292zm-4.583 2.292v2.292h2.292V9.472H7.071zm9.167 0v2.292h2.292V9.472h-2.292zM4.583 9.472v2.292h2.292V9.472H4.583zm14.75 0v2.292h2.292V9.472h-2.292zM11.654 11.764v2.292h2.292v-2.292h-2.292zm-9.167 2.292v2.292h2.292v-2.292H2.487zm18.416 0v2.292H23v-2.292h-2.097zM7.071 14.056v2.292h2.292v-2.292H7.071zm9.167 0v2.292h2.292v-2.292h-2.292zM11.654 16.348v2.292h2.292v-2.292h-2.292zm-7.071 2.292v2.292h2.292V18.64H4.583zm14.75 0v2.292h2.292V18.64h-2.292zM7.071 18.64v2.292h2.292V18.64H7.071zm9.167 0v2.292h2.292V18.64h-2.292zM11.654 20.932V24h2.292v-3.068h-2.292z"/>
                  </svg>
                )}
